        ...
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.Section == "APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION").Count() == 0)
            {
                items.Add(new FormSection()
                {
					...
					DisplayCondition = CONDITION_APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION(),
            ...
            if (db.AsQueryable().Where(x => x.Section == "APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION").Count() == 0)
            {
                items.Add(new FormSectionRow()
                {
                    ...
                    Controls = new List<FormControl>()
                    {
                        ...
                        {
                            FieldID = "F36_03_41",
                            Control = "APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION_HEADING",
                            Type = ControlType.Heading,
                            DataKey = "APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION_HEADING",
                            ColFixed = 12,
                        	DisplayCondition = CONDITION_APP_LAW_OFFICE_EDIT_LAWYER_LEAVE_HEADER_SECTION_HEADING(),
                        	ResourceName = "PermitResource.RESOURCE_APP_LAW_OFFICE_EDIT",
                        },
                    }
                });
