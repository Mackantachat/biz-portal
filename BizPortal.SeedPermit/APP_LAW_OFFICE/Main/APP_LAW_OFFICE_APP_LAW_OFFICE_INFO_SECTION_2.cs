                ...
                items.Add(new FormSectionRow()
                {
                    ...
                    Controls = new List<FormControl>()
                    {
                        ...
                        new FormControl()
                        {
                            ...
                            {
                                "APP_LAW_OFFICE_INFO_SECTION_2_CONFIRM_TRUE", /* ข้าพเจ้าขอรับรองว่า ข้อมูลที่ข้าพเจ้าให้ไว้ต่อสภาทนายความเป็นจริงทั้งสิ้น หากเป็นเท็จยินยอมให้สภาทนายความดำเนินการตามที่เห็นสมควรได้ทันที และข้าพเจ้ายินดีให้ปฎิบัติตามกฎ ระเบียบ ที่สำนักงานทะเบียนสภาทนายความได้ประกาศใช้แล้ว หรือที่จะประกาศใช้ต่อไปทุกประการ */
                            },
