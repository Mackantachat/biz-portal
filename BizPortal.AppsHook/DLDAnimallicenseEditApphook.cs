...
{
    public class DLDAnimallicenseEditApphook : StoreBaseAppHook
    {
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var organizationName = requestLicenseOriginal.Data.TryGetData("INFORMATION_STORE").ThenGetStringData("INFORMATION_STORE_NAME_TH_CUSTOM").ToThaiDigit(); ;
            var organizationAmountOfBed = requestLicenseOriginal.Data.TryGetData("APP_ANIMAL_LICENSE_INFO").ThenGetStringData("APP_ANIMAL_LICENSE_INFO_AMOUNT").ToThaiDigit(); ;
            ...
            if (requestLicenseOriginal.Data.TryGetData("APP_ANIMAL_LICENSE_INFO").ThenGetStringData("APP_ANIMAL_LICENSE_INFO_TYPE_OPTION") == "APP_ANIMAL_MED_TYPE_ONE")
            {
                organizationType = "ประเภทไม่มีที่พักสัตว์ป่วยไว้ค้างคืน";
                organizationAmountOfBed = "-";
            }
            else if (requestLicenseOriginal.Data.TryGetData("APP_ANIMAL_LICENSE_INFO").ThenGetStringData("APP_ANIMAL_LICENSE_INFO_TYPE_OPTION") == "APP_ANIMAL_MED_TYPE_TWO")
            {
            ...
            if (request.IdentityType == UserTypeEnum.Citizen)
            {
                ...
                schemaEngName = "Request-to-amend-the-license-to-operate-an-animal-hospital";
            }
            else if (request.IdentityType == UserTypeEnum.Juristic)
            {
                schemaEngName = "Request-to-amend-the-license-to-operate-an-animal-hospital-juristic";
