...
{
    public class DLTNonRegularTruckEditAppHook : StoreBaseAppHook
    {
        ...
        {
            string src = serverMapPathFunc("~/Uploads/apps/dlt/app39_edit.pdf");
            PDFFieldValue field;
            ...
            if (req.Data.ContainsKey("APP_TRANSPORT_NON_REGULAR_TRUCK_EDIT_INFO_SECTION"))
                model.Add(new PDFFieldValue() { FieldName = "Reason2", Value = req.Data["APP_TRANSPORT_NON_REGULAR_TRUCK_EDIT_INFO_SECTION"].Data.TryGetString("APP_TRANSPORT_NON_REGULAR_TRUCK_EDIT_INFO_SECTION_PURPOSE") });
