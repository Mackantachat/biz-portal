...
{
    public class HSSHospitalBusinessApphook : StoreBaseAppHook
    {
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var typeMedicalFacility = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_INFO_SECTION_HEADER_TYPE");
            var characteristicsSanatorium = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetStringData("DROPDOWN_APP_HOSPITAL_PERMISSION_INFO_SECTION_HOSPITAL_DETAIL_TEXT");
            ...
            var numberOfBed = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_INFO_SECTION_BED_AMOUNT");
            var services = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_INTERNAL_MEDICINE") == true ? "อายุรกรรม," : string.Empty;
         
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_SURGERY") == true ? "ศัลยกรรม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_OBSTETRICS") == true ? "สูตินรีเวชกรรม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_PEDIATRICS") == true ? "กุมารเวชกรรม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_MEDICAL_TECHNOLOGY") == true ? "แผนกเทคนิคการแพทย์," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_ORTHOPEDIC_DEPARTMENT") == true ? "แผนกออร์โธปิดิกส์," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_DERMATOLOGY_DEPARTMENT") == true ? "แผนกโรคผิวหนัง," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_ARTIFICIAL_INSEMINATION") == true ? "แผนกการผสมเทียม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_PHYSICAL_THERAPY") == true ? "แผนกกายภาพบำบัด," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_THAI_TRADITIONAL_MEDICINE") == true ? "แผนกการแพทย์แผนไทย," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_NUTRITION_DEPARTMENT") == true ? "แผนกโภชนาการ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_LAUNDRY_DEPARTMENT") == true ? "แผนกซักฟอก," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_INTENSIVE_CARE_UNIT") == true ? "หอผู้ป่วยหนัก," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_INTERNAL_EXAMINATION") == true ? "ห้องตรวจภายในและขูดมดลูก," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_SMALL_OPERATING_ROOM") == true ? "ห้องผ่าตัดเล็ก," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_TREATMENT_ROOM") == true ? "ห้องให้การรักษา," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_AFTER_BIRTH") == true ? "ห้องทารกหลังคลอด," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_ORGAN_TRANSPLANT") == true ? "การผ่าตัดเปลี่ยนอวัยวะ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_HEMODIALYSIS_ROOM") == true ? "ห้องไตเทียม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_DENTAL_ROOM") == true ? "ห้องทันตกรรม," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_DIAGNOSTIC_RADIATION") == true ? "รังสีวินิจฉัยด้วยคอมพิวเตอร์," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_OPEN_HEART_SURGERY") == true ? "การผ่าตัดเปิดหัวใจ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_CARDIAC_CATHETERIZATION") == true ? "การสวนหัวใจ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_RADIATION_THERAPY") == true ? "รังสีบำบัด," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_EXAMINATION_MAGNETIC_FIELD") == true ? "การตรวจอวัยวะภายในชนิดสนามแม่เหล็กไฟ้ฟ้า," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_BREAKDOWN") == true ? "การสลายนิ่วด้วยเครื่องมือ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_MORGUE") == true ? "ห้องเก็บศพ," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_THAI_TRADITIONAL_MEDICINE_APPLIED") == true ? "แผนกการแพทย์แผนไทยประยุกต์," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_MASSAGE_DEPARTMENT") == true ? "แผนกการนวด," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_CHINESE_MEDICINE") == true ? "แผนกการแพทย์แผนจีน," : string.Empty);
            services = services + (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetBooleanData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_OTHER") == true ? request.Data.TryGetData("APP_HOSPITAL_PERMISSION_INFO_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_INFO_SECTION_ONLINE_SERVICE_OTHER_TEXT") + "," : string.Empty);
                        ...
                        new {
                            ...
                            resource = new {
                                Composition = new {
                                    ...
                                    title = new {
                                        attr_value = "ขอใบอนุญาตให้ประกอบกิจการสถานพยาบาล(โรงพยาบาล)"
                                    },
                                    relatesTo = new {
                                        code = new {
                                            attr_id = "NEW",
                        ...
                        new {
                            ...
                            resource = new {
                                HealthcareService = new {
                                    ...
                                    specialty = new {
                                        text = new {
                                            attr_value = numberOfBed.ToThaiDigit() // จำนวนเตียง คลินิคไม่มีจำนวนเตียง
                                        }
                                    },
                                    comment = new {
