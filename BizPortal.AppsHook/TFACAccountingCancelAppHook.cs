...
{
    public class  TFACAccountingCancelAppHook : SingleFormRendererAppHook
    {
        ...
        public override bool InvokeSingleForm(Guid trid, string currentSectionGroup, ref SingleFormRequestViewModel model)
        {
            ...
            var userData = new TFACDataGetRequest
            {
                data = new data()
                {
                    //ApplicationRequest_ID = "6f4b80ba-f1a6-4d69-a3c6-e69bc664bfb2"
                }
            };
            ...
            response =  Api.Call(ConfigurationManager.AppSettings["TFAC_WS_URL_GETREQUEST"], HttpVerb.POST, null, userDataString, ContentType.ApplicationJson);
