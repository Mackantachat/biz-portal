...
{
    public class HSSHospitalOperationApphook : StoreBaseAppHook
    {
        ...
        public override JObject GenerateELicenseData(Guid applicationrequestId)
        {
            ...
            var request = ApplicationRequestEntity.Get(applicationrequestId);
            var files = request.UploadedFiles.Where(e => e.Description == "HOSPITAL_PERMISSION_RECEIVE_FILE_SECTION").FirstOrDefault();
            var ownerTotal = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetIntData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_TOTAL");
            var ownerName = "";
            ...
            for (int i = 0; i <= ownerTotal; i++)
            {
                if (request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_DETAIL_OPTION_" + i) == "OPARETOR")
                {
                    ownerName = string.Format("{0} {1}", request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_FIRSTNAME_" + i), request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_LASTNAME_" + i));
                    break;
                }
            }

            var ownerPhotoMeta = files.Files.Where(e => e.FileTypeCode.Contains("HOSPITAL_PERMISSION_NEW_PHOTO_BIG") && e.Extras.Where(o => o.Key == "FILETYPENAME" && o.Value.ToString().Contains(ownerName)).Any()).FirstOrDefault().Adapt<BizPortal.ViewModels.V2.FileMetadata>();
            ...
            var practitionerPhoto = Convert.ToBase64String(ownerPhotoMeta.GetBytes());
            var practitionerPhotoContentType = "image/jpg";
            var practitionerPhotoUrl = "";
            var practitionerPhotoSize = ownerPhotoMeta.FileSize;
            var practitionerPhotoTitle = ownerPhotoMeta.FileName;
            var oparetorName = request.Data.TryGetData("ELICENSE_INFORMATION").ThenGetStringData("IdentifierName");
            var totalOperator = 0;
            var hospitalOwned = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").Data;
            ...
            var hospitalCharacteristics = string.Empty;
            var typeMedicalFacility = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_HOSPITAL_TYPE_OPTION__RADIO_TEXT_0");
            ...
            if (int.TryParse(hospitalOwned["APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_TOTAL"], out totalOperator))
            {
                for (int i = 0; i < totalOperator; i++)
                {
                    if (hospitalOwned.ContainsKey("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_DETAIL_OPTION_" + i))
                    {
                        ...
                        {
                            var titleOperator = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("DROPDOWN_APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_TITLE_TEXT_" + i).Contains("นาย") ? "นายแพทย์" : "แพทย์หญิง";
                            
                            //oparetorName = titleOperator + " " + request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_FIRSTNAME_" + i) + " " +
                            //               request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_LASTNAME_" + i);
                            professionalLicenseNumber = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_LICENSE_NUMBER_" + i);
                            fieldPractitionerBranch = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("DROPDOWN_APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_TYPE_TEXT_" + i) +
                                                       request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("DROPDOWN_APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_BRANCH_TEXT_" + i);
                            fieldPractitionerLicenseDate = request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_LICENSING_DATE_" + i);
                            hospitalCharacteristics = string.Format("{0} {1}", request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("DROPDOWN_APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_HOSPITAL_DETAIL_TEXT_" + i), request.Data.TryGetData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION").ThenGetStringData("APP_HOSPITAL_PERMISSION_OWNER_OPARETOR_SECTION_HOSPITAL_OTHER_" + i));
