...
{
    class OCPBDirectMarketingAppHook : SingleFormRendererAppHook
    {
        ...
        //ขอจดทะเบียนการประกอบธุรกิจตลาดแบบตรง บุคคลธรรมดา
                ...
                rsm__ExchangedDocument = new
                {
                    ...
                    ram__SubmitterParty = new
                    {
                        ...
                        ram__PostalAddress = new
                        {
                            ...
                            ram__CityName = addressDistrict.RemoveTextDistrict(),
