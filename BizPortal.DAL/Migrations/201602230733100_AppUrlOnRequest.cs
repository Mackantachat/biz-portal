namespace BizPortal.DAL.Migrations
{
    ...
    public partial class AppUrlOnRequest : DbMigration
    {
        public override void Up()
        {
            Sql(@"
ALTER VIEW [dbo].[JuristicRequestView]
AS
SELECT DISTINCT 
                         ...
                         dbo.AspNetUsers.UserType, dbo.AspNetUsers.CitizenID, dbo.AspNetUsers.PassportID, dbo.Application.ConsumerKey, dbo.Application.ApplicationUrl
