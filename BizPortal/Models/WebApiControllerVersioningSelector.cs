...
namespace BizPortal.Models
{
    ...
    /// </summary>
    public class WebApiControllerVersioningSelector : IHttpControllerSelector
    {
        ...
        public WebApiControllerVersioningSelector(HttpConfiguration config)
        {
        ...
        private Dictionary<string, HttpControllerDescriptor> InitializeControllerDictionary()
        {
            ...
            foreach (Type t in controllerTypes)
            {
                ...
                var key = String.Format(CultureInfo.InvariantCulture, "{0}.{1}", segments[segments.Length - 2], controllerName).ToUpper();
        ...
        public HttpControllerDescriptor SelectController(HttpRequestMessage request)
        {
            ...
            namespaceName = namespaceName.ToLower() == "v1" ? string.Empty : namespaceName;
            ...
            string key = String.Format(CultureInfo.InvariantCulture, "WebApi{0}.{1}", namespaceName, controllerName).ToUpper();
