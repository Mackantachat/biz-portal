...
namespace BizPortal.Utils
{
    public static class Base64
    {
        ...
        {
            StringBuilder result = new StringBuilder(System.Convert.ToBase64String(input).TrimEnd('='));
            result.Replace('+', '-');
            result.Replace('/', '_');
        ...
        public static byte[] Base64urlStringToByte(string base64ForUrlInput)
        {
            ...
            result.Replace('-', '+');
            result.Replace('_', '/');
            return System.Convert.FromBase64String(result.ToString());
        }

        public static string Base64StringToBase64urlString(string base64string)
        {
            byte[] convertByte = System.Convert.FromBase64String(base64string);
        ...
        public static string Base64urlStringToBase64String(string base64urlstring)
        {
            ...
            return System.Convert.ToBase64String(convertData);
        }
    }
}
