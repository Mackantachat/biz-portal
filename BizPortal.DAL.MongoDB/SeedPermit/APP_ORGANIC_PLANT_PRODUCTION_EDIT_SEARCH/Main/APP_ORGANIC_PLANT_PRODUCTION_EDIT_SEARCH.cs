...
{
    public partial class APP_ORGANIC_PLANT_PRODUCTION_EDIT_SEARCH
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_ORGANIC_PLANT_PRODUCTION_EDIT_SEARCH").Count() == 0)
            {
            ...
            // Init Section
            APP_ORGANIC_PLANT_PRODUCTION_EDIT_SEARCH_APP_ORGANIC_PLANT_PRODUCTION_EDIT_SEARCH_SEARCH_SECTION.Init();
        }
    }
}
