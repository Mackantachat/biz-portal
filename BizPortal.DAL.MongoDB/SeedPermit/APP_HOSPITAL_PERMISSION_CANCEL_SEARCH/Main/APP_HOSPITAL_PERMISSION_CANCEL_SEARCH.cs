...
{
    public partial class APP_HOSPITAL_PERMISSION_CANCEL_SEARCH
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_HOSPITAL_PERMISSION_CANCEL_SEARCH").Count() == 0)
            {
            ...
            // Init Section
            APP_HOSPITAL_PERMISSION_CANCEL_SEARCH_APP_HOSPITAL_PERMISSION_CANCEL_SEARCH_SEARCH_SECTION.Init();
        }
    }
}
