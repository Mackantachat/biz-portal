...
namespace BizPortal.SeedPermit.APP_ACCOUNTING_DETAIL
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ACCOUNTING_DETAIL_POLICY_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_ACCOUNTING_DETAIL_POLICY_SECTION()
        {
