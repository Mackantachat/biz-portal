...
namespace BizPortal.SeedPermit.APP_ACCOUNTING_DETAIL
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ACCOUNTING_DETAIL_DEPOSIT_CARD_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_ACCOUNTING_DETAIL_DEPOSIT_CARD_SECTION()
        {
        ...
        private static Select2Opt[] DROPDOWN_APP_ACCOUNTING_DETAIL_DEPOSIT_CARD_SECTION_BANK_NAME()
        {
