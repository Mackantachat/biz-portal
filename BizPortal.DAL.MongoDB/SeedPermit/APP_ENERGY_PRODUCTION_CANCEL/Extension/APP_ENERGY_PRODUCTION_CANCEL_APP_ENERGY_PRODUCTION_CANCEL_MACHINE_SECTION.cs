...
namespace BizPortal.SeedPermit.APP_ENERGY_PRODUCTION_CANCEL
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ENERGY_PRODUCTION_CANCEL_MACHINE_SECTION()
        {
        ...
        private static FormControl.NumberSettings SETTING_NUMBER_APP_ENERGY_PRODUCTION_CANCEL_MACHINE_SECTION_HORSEPOWER()
        {
