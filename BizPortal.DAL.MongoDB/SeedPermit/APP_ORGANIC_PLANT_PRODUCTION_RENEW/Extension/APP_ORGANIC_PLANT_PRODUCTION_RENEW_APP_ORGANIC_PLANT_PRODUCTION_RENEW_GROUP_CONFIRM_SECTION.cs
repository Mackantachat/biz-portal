...
namespace BizPortal.SeedPermit.APP_ORGANIC_PLANT_PRODUCTION_RENEW
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ORGANIC_PLANT_PRODUCTION_RENEW_GROUP_CONFIRM_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_ORGANIC_PLANT_PRODUCTION_RENEW_GROUP_CONFIRM_SECTION()
        {
