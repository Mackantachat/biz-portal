...
{
    public partial class APP_CLINIC_RENEW_SEARCH
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_CLINIC_RENEW_SEARCH").Count() == 0)
            {
            ...
            // Init Section
            APP_CLINIC_RENEW_SEARCH_APP_CLINIC_RENEW_SEARCH_SEARCH_SECTION.Init();
        }
    }
}
