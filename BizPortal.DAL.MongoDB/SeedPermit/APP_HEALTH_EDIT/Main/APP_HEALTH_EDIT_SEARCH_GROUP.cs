...
{
    public partial class APP_HEALTH_EDIT_SEARCH_GROUP
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_HEALTH_EDIT_SEARCH_SECTION_GROUP").Count() == 0)
            {
            ...
            // Init Section
            APP_HEALTH_EDIT_SEARCH_SECTION.Init();
        }
    }
}
