...
namespace BizPortal.SeedPermit.APP_ACCOUNTING_SERVICE_EDIT_TYPE_2
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ACCOUNTING_SERVICE_EDIT_TYPE_2_CORPARATE_BONDS_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_ACCOUNTING_SERVICE_EDIT_TYPE_2_CORPARATE_BONDS_SECTION()
        {
