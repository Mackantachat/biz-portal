...
namespace BizPortal.SeedPermit.APP_TRANSPORT_NON_REGULAR_TRUCK
{
    ...
    {
        private static FormRadioGroup RADIO_GROUP_APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_JURISTIC()
        {
            return new FormRadioGroup()
            {
                RadioGroupName = "APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_JURISTIC_OPTION",
        ...
        private static FormRadioGroup RADIO_GROUP_APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_CITIZEN()
        {
            return new FormRadioGroup()
            {
                RadioGroupName = "APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_CITIZEN_OPTION",
                RadioButtons = new FormRadioButton[]
                {
        ...
        private static FormRadioGroup RADIO_GROUP_APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_RENTING_OWNER_TYPE()
        {
            return new FormRadioGroup()
            {
                RadioGroupName = "APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_RENTING_OWNER_TYPE_OPTION",
                RadioButtons = new FormRadioButton[]
                {
        ...
        private static FormControlDisplayCondition CONDITION_APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_RENTING_OWNER_TYPE()
        {
            return new FormControlDisplayCondition
            {
                ...
                Conditions = new FormControlDisplayCondition.ControlWithAnswer[]
                {
                    ...
                    {
                        ControlName = "APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_JURISTIC",
                    ...
                    new FormControlDisplayCondition.ControlWithAnswer
                    {
                        ControlName = "APP_TRANSPORT_NON_REGULAR_TRUCK_MAINTENANCE_SECTION_BUILDING_TYPE_CITIZEN",
                        ControlAnswer = StoreInformationBuildingTypeOptionValueConst.RENT,
                    },
                    new FormControlDisplayCondition.ControlWithAnswer
                    {
