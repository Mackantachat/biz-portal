...
namespace BizPortal.SeedPermit.APP_TRANSPORT_NON_REGULAR_TRUCK
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_TRANSPORT_NON_REGULAR_TRUCK_PLACE_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_TRANSPORT_NON_REGULAR_TRUCK_PLACE_SECTION()
        {
