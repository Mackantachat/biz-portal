...
{
    public partial class APP_HOSPITAL_PERMISSION_CANCEL
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_HOSPITAL_PERMISSION_CANCEL").Count() == 0)
            {
            ...
            // Init Section
            APP_HOSPITAL_PERMISSION_CANCEL_APP_HOSPITAL_PERMISSION_CANCEL_INFO_SECTION.Init();
        }
    }
}
