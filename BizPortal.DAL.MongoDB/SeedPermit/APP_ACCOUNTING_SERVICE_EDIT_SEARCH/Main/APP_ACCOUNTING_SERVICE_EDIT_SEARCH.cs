...
{
    public partial class APP_ACCOUNTING_SERVICE_EDIT_SEARCH
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.SectionGroup == "APP_ACCOUNTING_SERVICE_EDIT_SEARCH").Count() == 0)
            {
            ...
            // Init Section
            APP_ACCOUNTING_SERVICE_EDIT_SEARCH_APP_ACCOUNTING_SERVICE_EDIT_SEARCH_SEARCH_SECTION.Init();
        }
    }
}
