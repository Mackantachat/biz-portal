...
namespace BizPortal.SeedPermit.APP_ACCOUNTING_SERVICE_RENEW
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ACCOUNTING_SERVICE_RENEW_THAI_BONDS_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_ACCOUNTING_SERVICE_RENEW_THAI_BONDS_SECTION()
        {
