...
namespace BizPortal.SeedPermit.APP_ELECTRONIC_COMMERCIAL_EDIT
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_ELECTRONIC_COMMERCIAL_EDIT_BRANCH_SECTION()
        {
            return new FormControlDisplayCondition
            {
                Conditions = new FormControlDisplayCondition.ControlWithAnswer[]
                {
                    ...
                    {
                        ControlName = "APP_ELECTRONIC_COMMERCIAL_EDIT_EDIT_BRANCH_SECTION_CHECKBOX_EDIT__EDIT_BRANCH_SECTION_CHECKED",
                        ControlAnswer = "true",
                    },
                },
            };
        ...
        private static FormControlDisableCondition DISABLE_APP_ELECTRONIC_COMMERCIAL_EDIT_BRANCH_SECTION()
        {
