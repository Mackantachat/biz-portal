...
namespace BizPortal.SeedPermit.APP_CLINIC_EDIT
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_CLINIC_EDIT_CERTIFICATE_SECTION()
        {
            return new FormControlDisplayCondition
            {
                Conditions = new FormControlDisplayCondition.ControlWithAnswer[]
                {
                    ...
                    {
                        ControlName = "APP_CLINIC_EDIT_OPERATOR_SECTION_BRANCH",
        ...
        private static FormControlDisableCondition DISABLE_APP_CLINIC_EDIT_CERTIFICATE_SECTION()
        {
