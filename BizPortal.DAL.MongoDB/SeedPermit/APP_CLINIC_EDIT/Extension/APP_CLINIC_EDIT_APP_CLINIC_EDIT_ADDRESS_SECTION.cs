...
namespace BizPortal.SeedPermit.APP_CLINIC_EDIT
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_CLINIC_EDIT_ADDRESS_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_CLINIC_EDIT_ADDRESS_SECTION()
        {
