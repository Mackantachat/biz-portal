...
namespace BizPortal.SeedPermit.APP_CLINIC_EDIT
{
    ...
    {
        private static FormControlDisplayCondition CONDITION_APP_CLINIC_EDIT_OPERATING_DATE_SECTION()
        {
        ...
        private static FormControlDisableCondition DISABLE_APP_CLINIC_EDIT_OPERATING_DATE_SECTION()
        {
        ...
        private static Select2Opt[] DROPDOWN_APP_CLINIC_EDIT_OPERATING_DATE_SECTION_START_TIME()
        {
            return FormSectionRow.optWorkingTime;
        }

        private static Select2Opt[] DROPDOWN_APP_CLINIC_EDIT_OPERATING_DATE_SECTION_END_TIME()
        {
