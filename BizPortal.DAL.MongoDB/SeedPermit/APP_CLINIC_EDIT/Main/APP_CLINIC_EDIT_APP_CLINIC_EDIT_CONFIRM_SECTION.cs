...
namespace BizPortal.SeedPermit.APP_CLINIC_EDIT
{
    public partial class APP_CLINIC_EDIT_APP_CLINIC_EDIT_CONFIRM_SECTION
    {
        public static void Init()
        {
            ...
            if (db.AsQueryable().Where(x => x.Section == "APP_CLINIC_EDIT_CONFIRM_SECTION").Count() == 0)
            {
     //           items.Add(new FormSection()
     //           {
     //               Section = "APP_CLINIC_EDIT_CONFIRM_SECTION",
     ...
     //               },
					...
					//DisplayCondition = CONDITION_APP_CLINIC_EDIT_CONFIRM_SECTION(),
					//DisableCondition = DISABLE_APP_CLINIC_EDIT_CONFIRM_SECTION(),
            ...
            if (db.AsQueryable().Where(x => x.Section == "APP_CLINIC_EDIT_CONFIRM_SECTION").Count() == 0)
            {
                items.Add(new FormSectionRow()
                {
                    ...
                    Controls = new List<FormControl>()
                    {
                        ...
                        {
                            FieldID = "F47_01_54",
                            Control = "APP_CLINIC_EDIT_CONFIRM_SECTION_OPERATOR_CONFIRM",
                            Type = ControlType.CheckBox,
                            DataKey = "APP_CLINIC_EDIT_CONFIRM_SECTION_OPERATOR_CONFIRM",
                            Info = "APP_CLINIC_EDIT_CONFIRM_SECTION_OPERATOR_CONFIRM_INFO",
                        ...
                        {
                            FieldID = "F47_01_55",
                            Control = "APP_CLINIC_EDIT_CONFIRM_SECTION_OPERATOR_CONFIRM_2",
                            Type = ControlType.CheckBox,
                            DataKey = "APP_CLINIC_EDIT_CONFIRM_SECTION_OPERATOR_CONFIRM_2",
                            IdentityTypes = new UserTypeEnum[] {
                                UserTypeEnum.Juristic,
                                UserTypeEnum.Citizen,
                            },
